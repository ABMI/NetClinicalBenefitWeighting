...
2. In `R`, use the following `devtools` command to install the NetClinicalBenefitWeighting package:
...
3. Once installed, you can execute the study by modifying and using the code below. For your convenience, this code is also provided under `extras/CodeToRun.R`:
	...
	```r
	library(NetClinicalBenefitWeighting)
	...
	outputFolder <- "c:/NetClinicalBenefitWeighting"
...
License
=======
The NetClinicalBenefitWeighting package is licensed under Apache License 2.0

Development
===========
NetClinicalBenefitWeighting was developed in ATLAS and R Studio.
